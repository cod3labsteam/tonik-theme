...
use function Cod3labs\Theme\App\config;
...
add_action('after_setup_theme', 'Cod3labs\Theme\App\Setup\add_theme_supports');
...
add_action('after_setup_theme', 'Cod3labs\Theme\App\Setup\load_textdomain');
