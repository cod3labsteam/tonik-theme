...
namespace Cod3labs\Theme\App\Setup;
...
add_filter('theme/index/sidebar/visibility', 'Cod3labs\Theme\App\Setup\show_index_sidebar');
add_filter('theme/single/sidebar/visibility', 'Cod3labs\Theme\App\Setup\show_index_sidebar');
...
add_filter('excerpt_length', 'Cod3labs\Theme\App\Setup\modify_excerpt_length');
