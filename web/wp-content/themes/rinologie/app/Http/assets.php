...
namespace Cod3labs\Theme\App\Http;
...
use function Cod3labs\Theme\App\asset_path;
...
add_action('wp_enqueue_scripts', 'Cod3labs\Theme\App\Http\register_stylesheets');
...
add_action('wp_enqueue_scripts', 'Cod3labs\Theme\App\Http\register_scripts');
...
add_action('admin_init', 'Cod3labs\Theme\App\Http\register_editor_stylesheets');
...
add_action('wp_default_scripts', 'Cod3labs\Theme\App\Http\move_jquery_to_the_footer');
