...
namespace Cod3labs\Theme\App\Structure;
...
add_action('theme/index/post/thumbnail', 'Cod3labs\Theme\App\Structure\render_post_thumbnail');
...
add_action('theme/index/content/none', 'Cod3labs\Theme\App\Structure\render_empty_content');
...
add_action('theme/single/content', 'Cod3labs\Theme\App\Structure\render_post_content');
...
add_action('theme/index/sidebar', 'Cod3labs\Theme\App\Structure\render_sidebar');
add_action('theme/single/sidebar', 'Cod3labs\Theme\App\Structure\render_sidebar');
...
add_action('theme/header/end', 'Cod3labs\Theme\App\Structure\render_documentation_button');
